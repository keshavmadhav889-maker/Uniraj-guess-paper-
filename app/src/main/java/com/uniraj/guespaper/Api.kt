...
interface UnirajApi {
 ...
 @POST("api/orders") suspend fun createOrder(@Body body: Map<String, Long>): OrderResponse
 @POST("api/orders/{ref}/submit-payment") suspend fun submitPayment(@Path("ref") ref: String, @Body body: SubmitPaymentRequest): Map<String, Any>
 @GET("api/me/orders") suspend fun orders(): List<Order>
 @GET("api/me/purchases") suspend fun purchases(): List<Purchase>
 @GET("api/papers/{id}/access") suspend fun access(@Path("id") id: Long): Map<String, String>
}
